...
<body>
    ...
    <nav class="navbar navbar-expand-lg minavbar">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo RUTA ?>"><h1 class="loguito">Mi primerBlog</h1></a>
            ...
            <form class="d-flex" role="search" action="<?php echo RUTA; ?>/buscar.php" method="get" name="busqueda">
